        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileUniqueId = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelegramPaymentId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    TelegramPreCheckoutQueryId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionPlans_Users_CreatedByAdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_TelegramPaymentId",
                table: "Purchases",
                column: "TelegramPaymentId",
                unique: true,
                filter: "[TelegramPaymentId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_CreatedByAdminId",
